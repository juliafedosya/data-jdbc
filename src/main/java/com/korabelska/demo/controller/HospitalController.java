...
public class HospitalController {
    ...
    public ResponseEntity<List<Department>> getDepartmentsByHospitalById(@PathVariable Long id) {
        Optional<Hospital> hospital = hospitalService.findById(id);
    ...
    public ResponseEntity<Department> getDepartmentByIdAndHospitalId
            (@PathVariable("id") Long hospitalId, @PathVariable Long departmentId) {
    ...
    public ResponseEntity<Hospital> createDepartment(@PathVariable("id") Long hospitalId,
        ...
        if (optionalHospital.isPresent()) {
            Hospital hospital = hospitalService.createDepartment(createDepartmentDto, optionalHospital.get());
            return new ResponseEntity<>(hospital, HttpStatus.CREATED);
        }
        return ResponseEntity.notFound().build();
    }
